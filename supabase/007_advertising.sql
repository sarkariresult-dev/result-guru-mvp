-- ═══════════════════════════════════════════════════════════════
-- 007_advertising.sql - Result Guru
...
CREATE TABLE IF NOT EXISTS ad_zones (
  ...
  width                 SMALLINT,
  height                SMALLINT,
  allowed_sizes         JSONB            NOT NULL DEFAULT '[]',
  appears_on            TEXT[]           NOT NULL DEFAULT ARRAY['all'],
...
CREATE TABLE IF NOT EXISTS ads (
  ...
  is_marked_ad           BOOLEAN       NOT NULL DEFAULT TRUE,
  starts_at              TIMESTAMPTZ,
  ends_at                TIMESTAMPTZ,
  impression_count       BIGINT        NOT NULL DEFAULT 0,
  click_count            BIGINT        NOT NULL DEFAULT 0,
  ctr                    NUMERIC(7,6) GENERATED ALWAYS AS (
                           CASE WHEN impression_count > 0 THEN click_count::NUMERIC / impression_count ELSE 0 END
                         ) STORED,
  created_at             TIMESTAMPTZ   NOT NULL DEFAULT NOW(),
  updated_at             TIMESTAMPTZ   NOT NULL DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS ad_events_2025_q1 PARTITION OF ad_events FOR VALUES FROM ('2025-01-01') TO ('2025-04-01');
ALTER TABLE ad_events_2025_q1 ENABLE ROW LEVEL SECURITY;

CREATE TABLE IF NOT EXISTS ad_events_2025_q2 PARTITION OF ad_events FOR VALUES FROM ('2025-04-01') TO ('2025-07-01');
ALTER TABLE ad_events_2025_q2 ENABLE ROW LEVEL SECURITY;

CREATE TABLE IF NOT EXISTS ad_events_2025_q3 PARTITION OF ad_events FOR VALUES FROM ('2025-07-01') TO ('2025-10-01');
ALTER TABLE ad_events_2025_q3 ENABLE ROW LEVEL SECURITY;

CREATE TABLE IF NOT EXISTS ad_events_2025_q4 PARTITION OF ad_events FOR VALUES FROM ('2025-10-01') TO ('2026-01-01');
ALTER TABLE ad_events_2025_q4 ENABLE ROW LEVEL SECURITY;

CREATE TABLE IF NOT EXISTS ad_events_2026_q1 PARTITION OF ad_events FOR VALUES FROM ('2026-01-01') TO ('2026-04-01');
ALTER TABLE ad_events_2026_q1 ENABLE ROW LEVEL SECURITY;

CREATE TABLE IF NOT EXISTS ad_events_2026_q2 PARTITION OF ad_events FOR VALUES FROM ('2026-04-01') TO ('2026-07-01');
ALTER TABLE ad_events_2026_q2 ENABLE ROW LEVEL SECURITY;

CREATE TABLE IF NOT EXISTS ad_events_2026_q3 PARTITION OF ad_events FOR VALUES FROM ('2026-07-01') TO ('2026-10-01');
ALTER TABLE ad_events_2026_q3 ENABLE ROW LEVEL SECURITY;

CREATE TABLE IF NOT EXISTS ad_events_2026_q4 PARTITION OF ad_events FOR VALUES FROM ('2026-10-01') TO ('2027-01-01');
ALTER TABLE ad_events_2026_q4 ENABLE ROW LEVEL SECURITY;

CREATE TABLE IF NOT EXISTS ad_events_default PARTITION OF ad_events DEFAULT;
ALTER TABLE ad_events_default ENABLE ROW LEVEL SECURITY;

-- ── 6. Aggregate Ad Stats ───────────────────────────────────
