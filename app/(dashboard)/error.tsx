        ...
        <div className="flex min-h-[60vh] items-center justify-center px-4">
            <div className="w-full max-w-sm space-y-6 text-center animate-fade-up">
                <div className="mx-auto flex size-16 items-center justify-center rounded-2xl border border-border bg-surface shadow-md">
                    <AlertTriangle className="size-8 text-error" strokeWidth={1.5} aria-hidden />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-foreground-muted">
                        {error.message || 'Something went wrong loading this page. Your data is safe.'}
                    </p>
                    {error.digest && (
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
                    ...
                    <Link
                        href="/"
                        className="inline-flex items-center justify-center gap-2 rounded-xl border border-border bg-surface px-6 py-3 text-sm font-semibold text-foreground shadow-xs transition-all hover:bg-background-subtle focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 active:scale-[0.97]"
                    >
